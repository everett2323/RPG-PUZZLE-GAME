...
class Player(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        self.animate()
        self.collide_enemy()
        #        print(f"before move: x={self.rect.x}, y=")
...
class Trophey(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        self.game = game
        self._layer = BLOCK_LAYER
        self.groups = self.game.all_sprites, self.game.blocks
        ...
        self.image = self.game.terrain_spritesheet.get_sprite(96, 192, self.width, 64)
...
class InGameButton(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        self.game = game
        self._layer = BLOCK_LAYER
        self.groups = self.game.all_sprites, self.game.blocks
        ...
        self.image = self.game.button_spritesheet.get_sprite(0, 0, self.width, self.height)
        ...
        self.animations = [self.game.button_spritesheet.get_sprite(0, 0, self.width, self.height),
                           self.game.button_spritesheet.get_sprite(32, 0, self.width, self.height),
                           self.game.button_spritesheet.get_sprite(64, 0, self.width, self.height)]
...
class TextButton:
    def __init__(self, x, y, width, height, fg, bg, content, size):
        self.font = pygame.font.Font('8bitoperator_jve.ttf', size)
